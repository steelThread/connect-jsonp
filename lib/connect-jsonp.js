...
module.exports = function jsonp() { 
    ...
    /**
     * Write the header using the previous middleware filter.
     */
    function previous(statusCode, headers, writeHead, res) {
    ...
    return function jsonp(req, res, next) {
        ...
        res.writeHead = function(statusCode, headers) {
            if (statusCode === 200) {
                ...
                previous(statusCode, headers, context.writeHead, res);
